...
ActiveRecord::Schema.define(version: 20160130222536) do
  ...
  create_table "brokers_countries", force: :cascade do |t|
    t.integer  "broker_id"
  ...
  create_table "brokers_languages", force: :cascade do |t|
  ...
  create_table "brokers_leads", force: :cascade do |t|
    t.integer  "broker_id"
    t.integer  "lead_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "languages_sites", force: :cascade do |t|
    t.integer  "language_id"
    t.integer  "site_id"
    t.datetime "created_at"
    t.datetime "updated_at"
